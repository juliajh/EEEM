...
urlpatterns = [
    ...
    path('community/toaddCommunitypage', views.toaddCommunitypage, name="toaddCommunitypage"),
    ...
    path('newproductDetail/<str:user>', views.newproductDetail, name='newproductDetail'),
